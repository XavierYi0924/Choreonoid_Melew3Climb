...
private:
  ...
  const double movingTime = 14.0;     // 動作時間[s]
    ...
    if(loop_time < movingTime){
      if(OFFFL){
        if(loop_time < bug_start){
          ...
          leg_pos_ref = {
            Eigen::Vector3d(FL_leg_offset_x_ , FL_leg_offset_y_, FL_leg_offset_z_ + bug_h),
            Eigen::Vector3d(FR_leg_offset_x_  + x_trajectory(controller_frequency * loop_time) , FR_leg_offset_y_, FR_leg_offset_z_),
            Eigen::Vector3d(BL_leg_offset_x_  + x_trajectory(controller_frequency * loop_time) , BL_leg_offset_y_, BL_leg_offset_z_ - z_trajectory(controller_frequency * loop_time)),
            Eigen::Vector3d(BR_leg_offset_x_  - x_trajectory(controller_frequency * loop_time) , BR_leg_offset_y_, BR_leg_offset_z_ - z_trajectory(controller_frequency * loop_time))
            };
        }
      }
      else if(OFFFR){
        if(loop_time < bug_start){
          ...
          leg_pos_ref = {
            Eigen::Vector3d(FL_leg_offset_x_  + x_trajectory(controller_frequency * loop_time) , FL_leg_offset_y_, FL_leg_offset_z_),
            Eigen::Vector3d(FR_leg_offset_x_ , FR_leg_offset_y_, FR_leg_offset_z_ + bug_h),
            Eigen::Vector3d(BL_leg_offset_x_  - x_trajectory(controller_frequency * loop_time) , BL_leg_offset_y_, BL_leg_offset_z_ - z_trajectory(controller_frequency * loop_time)),
            Eigen::Vector3d(BR_leg_offset_x_  + x_trajectory(controller_frequency * loop_time) , BR_leg_offset_y_, BR_leg_offset_z_ - z_trajectory(controller_frequency * loop_time))
            };
        }
        ...
        if(loop_time < bug_start){
          ...
          leg_pos_ref = {
            Eigen::Vector3d(FL_leg_offset_x_  - x_trajectory(controller_frequency * loop_time), FL_leg_offset_y_, FL_leg_offset_z_- z_trajectory(controller_frequency * loop_time)),
            Eigen::Vector3d(FR_leg_offset_x_  + x_trajectory(controller_frequency * loop_time), FR_leg_offset_y_, FR_leg_offset_z_- z_trajectory(controller_frequency * loop_time)),
            Eigen::Vector3d(BL_leg_offset_x_ , BL_leg_offset_y_, BL_leg_offset_z_ + bug_h),
            Eigen::Vector3d(BR_leg_offset_x_  - x_trajectory(controller_frequency * loop_time), BR_leg_offset_y_, BR_leg_offset_z_)
            };
        }
      }
      else if(OFFBR){
        if(loop_time < bug_start){
          ...
          leg_pos_ref = {
            Eigen::Vector3d(FL_leg_offset_x_ + x_trajectory(controller_frequency * loop_time), FL_leg_offset_y_, FL_leg_offset_z_),
            Eigen::Vector3d(FR_leg_offset_x_ - x_trajectory(controller_frequency * loop_time), FR_leg_offset_y_, FR_leg_offset_z_),
            Eigen::Vector3d(BL_leg_offset_x_ - x_trajectory(controller_frequency * loop_time), BL_leg_offset_y_, BL_leg_offset_z_),
            Eigen::Vector3d(BR_leg_offset_x_ , BR_leg_offset_y_, BR_leg_offset_z_ + bug_h)
            };
        }
      ...
      if(OFFFL){
        leg_pos_ref = {
          ...
          Eigen::Vector3d(BL_leg_offset_x_+x2.x, BL_leg_offset_y_, BL_leg_offset_z_ - z2.x),
          Eigen::Vector3d(BR_leg_offset_x_-x2.x, BR_leg_offset_y_, BR_leg_offset_z_ - z2.x)
          };
      }
      else if(OFFFR){
        leg_pos_ref = {
        ...
        leg_pos_ref = {
          Eigen::Vector3d(FL_leg_offset_x_-x2.x, FL_leg_offset_y_, FL_leg_offset_z_- z2.x),
          Eigen::Vector3d(FR_leg_offset_x_+x2.x, FR_leg_offset_y_, FR_leg_offset_z_- z2.x),
          Eigen::Vector3d(BL_leg_offset_x_, BL_leg_offset_y_, BL_leg_offset_z_ + bug_h),
