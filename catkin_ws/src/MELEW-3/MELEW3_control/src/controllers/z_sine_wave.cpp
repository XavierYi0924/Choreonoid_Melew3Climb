...
class z_sine_wave : public BaseController {
private:
 ...
 *
 */
void z_sine_wave::control_loop(void) {
  ...
  // Move z sine wave
    ...
    */
    ...
    COM_pos_ref = Eigen::Vector3d(0.0, 0.0, z_init + z_amplitude * (1 - cos(2 * M_PI * z_frequency * loop_time)));
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "z_sine_wave");
  // ROS_WARN("zsin in");
  MELEW3_control::BaseController* controller = new MELEW3_control::z_sine_wave;
  ros::waitForShutdown();
  return 0;
}
