    ...
    */
    ...
    if(loop_time < movingTime){
      ...
      leg_motor_torque = init_torque;
        if(loop_time < start_time1)
        {
          pos_temp = turning_rate* loop_time;
          leg_yaw_ref = {pos_temp, pos_temp, -pos_temp, -pos_temp};
          // leg_yaw_ref = init_leg_yaw;
          COM_yaw_ref = pos_temp;
          // COM_yaw_ref = init_COM_yaw;
          leg_yaw_ref_temp = leg_yaw_ref;
          COM_yaw_ref_temp = COM_yaw_ref;
          printf("1");
        }
        else if(loop_time > end_time1 && loop_time < start_time2){
          pos_temp = turning_rate * 2 - turning_rate* (loop_time - end_time1);
          leg_yaw_ref = {pos_temp, pos_temp, -pos_temp, -pos_temp};
          // leg_yaw_ref = init_leg_yaw;
          COM_yaw_ref = pos_temp;
          // COM_yaw_ref = init_COM_yaw;
        ...
        else if(loop_time > end_time2 && loop_time < start_time3)
        {
          pos_temp =turning_rate* (loop_time - end_time2) - turning_rate * 2;
          leg_yaw_ref = {pos_temp, pos_temp, -pos_temp, -pos_temp};
          // leg_yaw_ref = init_leg_yaw;
          COM_yaw_ref = pos_temp;
          // COM_yaw_ref = init_COM_yaw;
        ...
        else if(loop_time > end_time3 && loop_time < start_time4)
        {
          pos_temp = turning_rate * 2 - turning_rate* (loop_time - end_time3);
          leg_yaw_ref = {pos_temp, pos_temp, -pos_temp, -pos_temp};
          // leg_yaw_ref = init_leg_yaw;
          COM_yaw_ref = pos_temp;
          // COM_yaw_ref = init_COM_yaw;
        ...
        else if(loop_time > end_time4 && loop_time < movingTime)
        {
          pos_temp = turning_rate* (loop_time - end_time4) - turning_rate* 2 ;
          leg_yaw_ref = {pos_temp, pos_temp, -pos_temp, -pos_temp};
          // leg_yaw_ref = init_leg_yaw;
          COM_yaw_ref = pos_temp;
          // COM_yaw_ref = init_COM_yaw;
          ...
          // leg_yaw_ref = leg_yaw_ref_temp;
          // COM_yaw_ref = COM_yaw_ref_temp;
          printf("0");
        }
        // printf("%d ", pos_temp_F);
      /*** 4脚車輪ロボットの軌道をパブリッシュ ***/
