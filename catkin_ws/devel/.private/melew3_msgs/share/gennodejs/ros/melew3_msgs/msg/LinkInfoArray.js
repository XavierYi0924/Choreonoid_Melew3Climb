...
class LinkInfoArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LinkInfoArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.position[i] = geometry_msgs.msg.Pose.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.velocity[i] = geometry_msgs.msg.Twist.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 56 * object.position.length;
    length += 48 * object.velocity.length;
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LinkInfoArray(null);
    ...
    if (msg.position !== undefined) {
      ...
      for (let i = 0; i < resolved.position.length; ++i) {
        resolved.position[i] = geometry_msgs.msg.Pose.Resolve(msg.position[i]);
      }
    }
    else {
      resolved.position = []
    ...
    if (msg.velocity !== undefined) {
      ...
      for (let i = 0; i < resolved.velocity.length; ++i) {
        resolved.velocity[i] = geometry_msgs.msg.Twist.Resolve(msg.velocity[i]);
      }
    }
    else {
      resolved.velocity = []
