...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melew3_msgs-msg:<PointArray> is deprecated: use melew3_msgs-msg:PointArray instead.")))
...
(cl:defmethod points-val ((m <PointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melew3_msgs-msg:points-val is deprecated.  Use melew3_msgs-msg:points instead.")
  (points m))
